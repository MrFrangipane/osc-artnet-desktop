...
class DaemonStarterWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._engine_starter = DaemonStarter()
        self._engine_starter.statusChanged.connect(self._status_changed)
        ...
        self._start_restart_button.clicked.connect(self._engine_starter.start_restart)

        self._stop_button = QPushButton()
        self._stop_button.setIcon(icons.stop())
        self._stop_button.setToolTip("Stop engine")
        self._stop_button.clicked.connect(self._engine_starter.stop)
